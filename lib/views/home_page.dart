...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildResultCepText() {
    return Padding(
      ...
      child: Text(
       text = _resultCep != null ? _resultCep.toJson() : 'Preencha os campos!',
    ...
    return TextFormField(
      ...
      validator: (value) {
        if (value.isEmpty) {
          ...
          return 'Por favor, o cep necessita no mínimo 8 digitos';
        }
      },
      autofocus: true,
  ...
  Widget _buildSearchUFTextField() {
    return TextFormField(
      ...
      keyboardType: TextInputType.text,
      textInputAction: TextInputAction.done,
      decoration: InputDecoration(labelText: 'Unidade Federal'),
